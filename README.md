...
## Demo / Screenshots
*Add your screenshots/GIFs here (put files in `assets/` and reference them). Example:*

![Home screen mockup](assets/screenshot-home.png)
![Search screen demo](assets/screenshot-search.png)
...
## Tech Stack
- Flutter 2.10.1 / Dart 2.3.0 (development versions used). :contentReference[oaicite:13]{index=13}  
- Firebase (Authentication, Firestore / Realtime DB if applicable, Storage). :contentReference[oaicite:14]{index=14}  
- External APIs: RAWG (v3), NewsAPI / Newscatcher (v2), optional IGDB. :contentReference[oaicite:15]{index=15} :contentReference[oaicite:16]{index=16}  
- Tools: Android Studio / VSCode, GitHub, Figma (UI design). :contentReference[oaicite:17]{index=17}
